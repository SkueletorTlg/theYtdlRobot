...
class Config(object):
    ...
    # watermark file
    DEF_WATER_MARK_FILE = "Renombrado por @RenameArchive_bot"
    ...
    CHANNEL_URL = os.environ.get("CHANNEL_URL", "©️ @BotsDeAyuda")
    UPDATE_CHANNEL = os.environ.get("CHANNEL_URL", "©️ @BotsDeAyuda")
